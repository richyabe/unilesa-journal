...
INSERT INTO editorial_board (name, role, institution, sort_order, active)
VALUES
  ('Prof. T. J. Ayoola',   'editor-in-chief',       'University of Ilesa, Ilesa, Osun State, Nigeria', 1, TRUE),
  ('Dr. I. S. Akinnadewo','managing-editor',         'University of Ilesa, Ilesa, Osun State, Nigeria', 2, TRUE),
  ('Dr. F. K. Akinloye',  'deputy-managing-editor',  'University of Ilesa, Ilesa, Osun State, Nigeria', 3, TRUE),
  ('Dr. Taiwo Ibitomi',   'board-member',             'University of Ilesa, Ilesa, Osun State, Nigeria', 4, TRUE),
  ('Dr. T. O. Adefisoye', 'board-member',             'University of Ilesa, Ilesa, Osun State, Nigeria', 5, TRUE),
  ('Dr. O. E. Ilevbare',  'board-member',             'University of Ilesa, Ilesa, Osun State, Nigeria', 6, TRUE),
  ('Dr. A. Olomola',      'board-member',             'University of Ilesa, Ilesa, Osun State, Nigeria', 7, TRUE)
ON CONFLICT DO NOTHING;
